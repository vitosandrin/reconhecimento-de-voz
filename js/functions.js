...
//math floor arredonda o valor definido em math random que multiplica o metodo pela var engine, objeto cores
function sortearCor (){
...
//prop style acessa e manipula declarações de css

function aplicarCorNaCaixa(nomeDaCor){
    var caixaDasCores = document.getElementById('cor-atual');

    caixaDasCores.style.backgroundColor = nomeDaCor;
    caixaDasCores.style.backgroundImage = "url('./assets/images/caixa-fechada.png')";
